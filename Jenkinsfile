pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/flohreh/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('cit-flohreh')   // <---- Change this to match your kubernetes cluster credentials
    }
